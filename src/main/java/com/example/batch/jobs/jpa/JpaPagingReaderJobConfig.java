package com.example.batch.jobs.jpa;
...
@Slf4j
@Configuration
@ConditionalOnProperty(name = "spring.batch.job.name", havingValue = "JPA_PAGING_CHUNK_JOB")
...
//    }
  ...
  public FlatFileItemWriter<Customer> customerJpaFlatFileItemWriter() {
    ...
    return new FlatFileItemWriterBuilder<Customer>()
        ...
        .resource(new FileSystemResource("./output/customer-output-new-4.csv"))
        .encoding(ENCODING)
        .delimited().delimiter("\t")
